...
public class GuiMainMenu extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        {
        	splashText = "FantaBobShow Edition !";
        }
        ...
        controlList.add(new GuiButton(4, width / 2 - 100, i + 72, "FantaBobShow"));
        ...
        } else
        {
            ...
            controlList.add(new GuiButton(5, width / 2 + 2, i + 96 + 12, 98, 20, stringtranslate.translateKey("menu.quit")));
        }
        if(mc.session == null)
        {
    ...
    protected void actionPerformed(GuiButton guibutton)
    {
        ...
        {
        	try {
				openLink(new URL("http://fantabobshow.com").toURI());
    ...
    public void drawScreen(int i, int j, float f)
    {
        ...
        GL11.glPopMatrix();
        drawString(fontRenderer, ModLoader.VERSION.replace("ModLoader", "Minecraft"), 2, 2, 0x505050);
